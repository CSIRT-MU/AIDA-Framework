...
public class Target {
     ...
     */
    public Target(
			List<String> type, List<String> hostname, List<String> iP4, List<String> mAC, List<String> iP6, List<Integer> port, List<String> proto, List<String> uRL, List<String> email, List<String> attachHand, String note, Boolean spoofed, Boolean imprecise, Boolean anonymised, List<Integer> aSN, List<String> router, List<URI> netname, List<URI> ref) {
        super();
        this.type = type;
