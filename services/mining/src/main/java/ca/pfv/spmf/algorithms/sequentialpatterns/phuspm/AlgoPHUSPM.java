...
public class AlgoPHUSPM {
	...
	public void AlgoPHUSPM(SequenceList Seq,
		...
		Iterator<Entry<Integer, SequenceList>> iter1 = itemExtend
				.entrySet().iterator();
		while (iter1.hasNext()) {// traverse mapOneItem, add frequent 1-itemsets
									// to frequentFuzzyOneItemset
			Entry<Integer, SequenceList> entry = (Entry<Integer, SequenceList>) iter1
					.next();
		...
		Iterator<Entry<Integer, SequenceList>> iter2 = itemsetExtend
				.entrySet().iterator();
		while (iter2.hasNext()) {// traverse mapOneItem, add frequent 1-itemsets
									// to frequentFuzzyOneItemset
			Entry<Integer, SequenceList> entry = (Entry<Integer, SequenceList>) iter2
					.next();
			entry.getValue().calculate();
