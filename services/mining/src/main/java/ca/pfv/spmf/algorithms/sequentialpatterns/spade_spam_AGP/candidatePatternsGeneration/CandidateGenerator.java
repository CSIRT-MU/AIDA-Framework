...
public interface CandidateGenerator {
     ...
     */
    public List<Pattern> generateCandidates(Pattern pattern1, Pattern pattern2, int minSupport, boolean doNotExploreXY,
			boolean doNotExploreYX, boolean doNotExploreX_Y, boolean doNotExploreY_X);
     ...
     */
    public IDList join(Pattern extension, EquivalenceClass equivalenceClass_i, EquivalenceClass equivalenceClass_j,
			int minSupport);
}
